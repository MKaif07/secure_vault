    ...
    <nav className="bg-vault-black border-b-4 border-vault-gray p-4 mb-8 flex justify-between items-center sticky top-0 z-50">
      <div className="flex items-center gap-6">
        <Link to="/" className="flex items-center gap-2 group">
          ...
          <span className="font-black uppercase tracking-tighter text-xl">Vault_OS</span>
        </Link>
        
        <div className="hidden md:flex gap-4 font-mono text-xs uppercase">
          <Link title="My Files" to="/" className="hover:text-white flex items-center gap-1">
            <HardDrive size={14} /> Drive
          </Link>
          <Link title="Audit Logs" to="/audit" className="hover:text-white flex items-center gap-1">
